...
class AzimuthRandomForest:
    def __init__(self, n_estimators=100, max_depth=None, random_state=42):
        ...
        """
        self.azimuth_bins = np.array([0., 30., 60., 90., 120., 150., 180., 210., 240., 270., 300., 330.])
    ...
    def _digitize_azimuth(self, true_azimuth_deg):
        ...
        normalized_azimuth = true_azimuth_deg % 360
        
        # Create bin edges: each bin covers 30 degrees
        # Bin 0: [345°, 15°), Bin 1: [15°, 45°), ..., Bin 11: [315°, 345°)
        bin_size = 30
        
        # Shift by half a bin size so that bin centers align with our target angles
        shifted_angle = (normalized_azimuth + 15) % 360
        
        # Find which bin this falls into
        bin_idx = int(shifted_angle // bin_size)
    ...
    def generate_training_data(self, n_samples=10000, max_radius=100):
        ...
        for i in range(n_samples):
            ...
            theta_true = np.random.uniform(0, 360)  # True azimuth in degrees (0-360)
